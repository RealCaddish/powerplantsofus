...
* Pick two or more fuel sources.
* Symbolize the power plant by the fuel source type and capacity.
  * For example, the radius of the circle marker should indicate capacity and color should indicate its type.
  * Note: some plants have more than one fuel source. See the challenge.
...
* Build a tooltip or popup so it displays the following content (shown below):
    * the name of the power plant in bold, and
    * the capacity produced by the plant for the selected fuel source.
...
If the plant has more than one fuel source: 
  * Symbolize the plants by the largest capacity fuel source. 
  * Popups should itemize the capacity of all fuel sources. 
